...
void RpcLibClientBase::simCreateVoxelGrid(const int& x, const int& y, const int& z, const float& res, const std::string& output_file)
{
    pimpl_->client.call("simCreateVoxelGrid", x, y, z, res, output_file);
}
