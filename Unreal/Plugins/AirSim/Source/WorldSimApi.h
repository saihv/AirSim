...
public:
    ...
    virtual void createVoxelGrid(const Vector3& position, const int& x_size, const int& y_size, const int& z_size, const float& res, const std::string& output_file) override;
